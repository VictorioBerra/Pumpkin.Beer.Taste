        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blind_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Blind_AspNetUsers_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlindItem_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlindItem_AspNetUsers_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlindVote_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlindVote_AspNetUsers_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blind_CreatedByUserId",
                table: "Blind",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Blind_UpdatedByUserId",
                table: "Blind",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlindItem_CreatedByUserId",
                table: "BlindItem",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlindItem_UpdatedByUserId",
                table: "BlindItem",
                column: "UpdatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlindVote_CreatedByUserId",
                table: "BlindVote",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlindVote_UpdatedByUserId",
                table: "BlindVote",
                column: "UpdatedByUserId");
        }
